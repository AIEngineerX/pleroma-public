...
export default function Plate({ dream, epoch }: { dream: DreamView; epoch: number }) {
  ...
  return (
    <figure className="my-4 mx-auto max-w-[52ch] border-4 p-2"
      ...
      <figcaption className="font-machine text-xs text-ink-faded pt-1">
        DREAM · epoch {epoch} · {pending ? "plate pending" : "generative replay"}
      </figcaption>
    </figure>
  );
}
