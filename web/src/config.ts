...
// Override per-build with VITE_API_BASE. Update this constant when the custom domain (pleroma.church) lands.
const PROD_API_BASE = "https://pleroma-worker-production.redacted.workers.dev";
